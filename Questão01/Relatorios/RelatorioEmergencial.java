...
public class RelatorioEmergencial implements IRelatorio {
    ...
    public RelatorioEmergencial(String fonte, String metricas, double tamanhoFonte, String formatos) {
        this.fonte = fonte;
    ...
    public void gerarRelatorio() {
        System.out.println("Gerando Relatório Emergencial com as seguintes configurações:");
