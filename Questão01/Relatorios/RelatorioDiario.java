...
public class RelatorioDiario implements IRelatorio {
    ...
    public RelatorioDiario(String fonte, String metricas, double tamanhoFonte, String formatos) {
        this.fonte = fonte;
    ...
    public void gerarRelatorio() {
        System.out.println("Gerando Relatório Diário com as seguintes configurações:");
